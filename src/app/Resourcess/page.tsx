  ...
  return (
    <div style={{overflow: 'hidden'}}>
      ...
      <div className={styles.imageH}>
        <Image src="https://res.cloudinary.com/dpwuym7xg/image/upload/v1756829071/zannya/uploads/kngkholnlp6wvmzq4pa8.jpg" alt="image" style={{ width: '100%', height: '700px', display: 'block' }}></Image>
      </div>
