...
// ----------------------
// Server Component with Firestore fetch
// ----------------------
export default async function Resourcess() {
  ...
  return (
    <main style={{ overflow: "hidden" }}>
      ...
      <section style={{ padding: "2rem", textAlign: "center" }}>
        ...
        <p>
          Zannya Africa Foundation provides research papers, reports, and case
          studies to empower communities and support sustainable development
          initiatives.
        </p>
      </section>
      ...
      <section style={{ textAlign: "center", paddingTop: "2rem" }}>
        ...
        >
          <a
            href="https://facebook.com/zannyaafricafoundation"
            target="_blank"
          ...
          <a
            href="https://instagram.com/zannya_africa_foundation"
            target="_blank"
            rel="noopener noreferrer"
          >
            <FaInstagram />
          ...
          <a
            href="https://tiktok.com/@zannyaafricafdn"
            target="_blank"
            rel="noopener noreferrer"
          >
            <FaTiktok />
        ...
        >
          <ul>
            ...
            <li>
              <a href="mailto:support@zannyaafricafoundation.org">
                support@zannyaafricafoundation.org
              </a>
            </li>
          </ul>
        </div>
