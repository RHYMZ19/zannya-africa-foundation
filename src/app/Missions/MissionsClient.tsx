...
{leaders
.filter(person =>
person.role.toLowerCase().includes("executive director"))
.map(person => (
...
{leaders
.filter(person =>
person.role.toLowerCase().includes("board member"))
.map(person => (
...
{leaders
.filter(person =>
person.role.toLowerCase().includes("project officer"))
.map(person => (
...
{leaders
.filter(person =>
person.role.toLowerCase().includes("intern"))
.map(person => (
...
<a href={selectedLeader.twitter} target="_blank" rel="noopener noreferrer">
<FaTwitter/>
</a>}

{selectedLeader.facebook &&
<a href={selectedLeader.facebook} target="_blank" rel="noopener noreferrer">
<FaFacebook/>
</a>}
