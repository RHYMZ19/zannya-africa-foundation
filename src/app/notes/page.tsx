...
notes(){
    ...
    <div className={styles.bin}>
        ...
        <p className={styles.paragraph}>
            ...
            the habits we adopt. Lifestyle encompasses various 
            aspects, including our routines, preferences, and overall 
            approach to life. When it comes to describing a lifestyle, 
            certain words can perfectly capture its essence. 
            From adventurous and active to laid-back and minimalist, 
        ...
        <p className={styles.paragraph}>
            ...
            encompasses various aspects, including our routines, preferences, 
            and overall approach to life. When it comes to describing a lifestyle, 
