...
const activities = [
  {
    imageTitle: "health education sessions",
  ...
  {
    imageTitle: "Peer to peer education",
  ...
  {
    imageTitle: "Personal Hygiene sessions",
